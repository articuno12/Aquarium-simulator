...
Matrix.prototype.ensure3x3 = function()
{
    ...
    for (var i = 0; i < this.elements.length; i++)
    {
        for (var j = this.elements[i].length; j < 3; j++)
        {
    ...
    for (var i = this.elements.length; i < 3; i++)
    {
        if (i == 0) this.elements.push([1, 0, 0]);
        else if (i == 1) this.elements.push([0, 1, 0]);
        else if (i == 2) this.elements.push([0, 0, 1]);
    }
