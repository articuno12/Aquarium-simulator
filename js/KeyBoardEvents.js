...
{
    if(event.keyCode == KeyList.KEY_I) Camera.MoveCameraV(1) ;
    else if(event.keyCode == KeyList.KEY_K) Camera.MoveCameraV(-1) ;
    else if(event.keyCode == KeyList.KEY_J) Camera.MoveCameraH(-1) ;
    ...
    else if(event.keyCode == KeyList.KEY_A) {Camera.ToggleFish() ; HumanControl ^= 1; }
